    ...
    const handleInputChange = (e: ChangeEvent<HTMLInputElement>): void => {
        ...
        if (name === "category") {
            setInfoProductos((prev) => ({
                ...prev,
                category: { ...prev.category, id: Number(value) },
            }));
        } else {
            setInfoProductos((prev) => ({
                ...prev,
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
        ...
        try {
            const productData = {
                ...
                categoryId: Number(infoProductos.category.id),
                images: infoProductos.images[0] ? [infoProductos.images[0]] : ["https://placeimg.com/640/480/any"],
            };
